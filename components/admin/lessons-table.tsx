...
export function LessonsTable({ data }: { data: Lesson[] }) {
  ...
  const resolvedLang =
    langParam === "ar" || langParam === "en" ? langParam : Array.isArray(langParam) ? langParam[0] : undefined
  const lang = resolvedLang === "ar" || resolvedLang === "en" ? resolvedLang : "ar"
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem asChild>
                  <Link href={`/${lang}/admin/courses/${lesson.courseId}/lessons/${lesson.id}`}>
